...
```{r, echo=TRUE, results='hide'}
      ...
      y
```
####Mean difference is `r x` and the median difference is `r y`
...
####The range os steps per weekday is much higher than during the weekdays. Here is the maximum number of steps during weekend `r y` compared with the maximum number of steps during weekend `r x`